...
//     expect(await dog.totalSupply()).to.equal("100");
//     expect(await dog.holders(0)).to.equal(account.address);
//     await dog.transfer(accounts[1].address, 100);
//     expect(await dog.balanceOf(accounts[1].address)).to.equal("100");
//   })
// });
